...
def sim_coords(df,field):
    ...
    if field == 3:
        coords = pd.read_csv('/media/bmr135/SAMSUNG/GA/K2Poles/avk_k2_complete_c3.txt',delimiter=r'\s+')
    if field == 6:
        coords = pd.read_csv('/media/bmr135/SAMSUNG/GA/K2Poles/avk_k2_complete_c6.txt',delimiter=r'\s+')
    if field == 'K':
        coords = pd.read_csv('/media/bmr135/SAMSUNG/GA/K2Poles/avk_kep_complete.txt',delimiter=r'\s+')
