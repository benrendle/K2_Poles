...
#     # plt.show()
    ...
    ax.text(0.1, 0.90, '(B)', horizontalalignment='center',verticalalignment='center',fontsize=15, transform=ax.transAxes,)
    ax.set_yticks([])
    ax.set_xlim(3.5,18)
...
#
    ...
    f = plt.figure()
    # print(K2_New['feh'])
    plt.plot([min(Luca['Gal_Rad'])-0.2,15],[0,0],color='r',linewidth=2,alpha=0.7,linestyle='--',label=None)
